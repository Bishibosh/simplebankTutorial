...
func (store *Store) execTx(ctx context.Context, fn func(*Queries) error) error { // when a function is an arguement like this, it is referred to as a callback
...
func addMoney(
	...
	if err != nil {
		return // because of the way we initialize the return typpe of this function, this is the same as doing: return account1, account2, err
	}
